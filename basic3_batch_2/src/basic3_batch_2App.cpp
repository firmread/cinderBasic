...
class basic3_batch_2App : public App {
  public:
	void setup() override;
	void draw() override;
...
void basic3_batch_2App::setup()
{
    ...
    mCam.lookAt(vec3(5,11,5), vec3());
}

void basic3_batch_2App::draw()
{
	gl::clear();
    gl::enableDepthRead();
    gl::enableDepthWrite();
...
CINDER_APP( basic3_batch_2App, RendererGl )
